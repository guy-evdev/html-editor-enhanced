...
class ToolbarWidgetState extends State<ToolbarWidget> {
                                  ...
                                  onPressed: () async {
                                    ...
                                    if (kIsWeb) {
                                      ...
                                      await widget.controller.editorController!.evaluateJavascript(
                                          source: "var height = \$('div.note-editable').outerHeight(true); window.flutter_inappwebview.callHandler('setHeight', height);");
                                    }
                                  },
                                ),
                              )),
  ...
  List<Widget> _buildChildren() {
    ...
    for (var t in widget.htmlToolbarOptions.defaultToolbarButtons) {
        ...
        toolbarChildren.add(Container(
          ...
          decoration: !widget.htmlToolbarOptions.renderBorder
              ...
              : widget.htmlToolbarOptions.dropdownBoxDecoration ??
                  BoxDecoration(color: Theme.of(context).scaffoldBackgroundColor, border: Border.all(color: Theme.of(context).colorScheme.onSurface.withOpacity(0.12))),
          child: CustomDropdownButtonHideUnderline(
            child: CustomDropdownButton<String>(
              ...
              menuMaxHeight: widget.htmlToolbarOptions.dropdownMenuMaxHeight ?? MediaQuery.of(context).size.height / 3,
              style: widget.htmlToolbarOptions.textStyle,
              items: [
                CustomDropdownMenuItem(value: 'p', child: PointerInterceptor(child: Text('Normal'))),
                ...
                CustomDropdownMenuItem(
                  value: 'h1',
                  child: PointerInterceptor(child: Text('Header 1', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 32))),
                ),
                CustomDropdownMenuItem(
                  value: 'h2',
                  child: PointerInterceptor(child: Text('Header 2', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 24))),
                ),
                CustomDropdownMenuItem(
                  value: 'h3',
                  child: PointerInterceptor(child: Text('Header 3', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 18))),
                ),
                CustomDropdownMenuItem(
                  value: 'h4',
                  child: PointerInterceptor(child: Text('Header 4', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16))),
                ),
                CustomDropdownMenuItem(
                  value: 'h5',
                  child: PointerInterceptor(child: Text('Header 5', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 13))),
                ),
                CustomDropdownMenuItem(
                  value: 'h6',
                  child: PointerInterceptor(child: Text('Header 6', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 11))),
                ),
              ],
              ...
              onChanged: (String? changed) async {
                ...
                if (changed != null) {
                  var proceed = await widget.htmlToolbarOptions.onDropdownChanged?.call(DropdownType.style, changed, updateSelectedItem) ?? true;
                  if (proceed) {
            ...
            child: CustomDropdownButtonHideUnderline(
              child: CustomDropdownButton<String>(
                ...
                items: [
                  CustomDropdownMenuItem(
                    value: 'Courier New',
                    child: PointerInterceptor(child: Text('Courier New', style: TextStyle(fontFamily: 'Courier'))),
                  ),
                  CustomDropdownMenuItem(
                    value: 'sans-serif',
                    child: PointerInterceptor(child: Text('Sans Serif', style: TextStyle(fontFamily: 'sans-serif'))),
                  ),
                  CustomDropdownMenuItem(
                    value: 'Times New Roman',
                    child: PointerInterceptor(child: Text('Times New Roman', style: TextStyle(fontFamily: 'Times'))),
                  ),
                ],
                ...
                onChanged: (String? changed) async {
                  ...
                  if (changed != null) {
                    var proceed = await widget.htmlToolbarOptions.onDropdownChanged?.call(DropdownType.fontName, changed, updateSelectedItem) ?? true;
                    if (proceed) {
              ...
              child: CustomDropdownButton<double>(
                ...
                onChanged: (double? changed) async {
                  ...
                  if (changed != null) {
                    ...
                    var proceed = await widget.htmlToolbarOptions.onDropdownChanged?.call(DropdownType.fontSize, changed, updateSelectedItem) ?? true;
                    if (proceed) {
                      switch (intChanged) {
                        case 1:
            ...
            child: CustomDropdownButtonHideUnderline(
              child: CustomDropdownButton<String>(
                ...
                onChanged: (String? changed) async {
                  ...
                  if (changed != null) {
                    var proceed = await widget.htmlToolbarOptions.onDropdownChanged?.call(DropdownType.fontSizeUnit, changed, updateSelectedItem) ?? true;
                    if (proceed) {
                      updateSelectedItem(changed);
                    }
                  }
          ...
          toolbarChildren.add(ToggleButtons(
            ...
            onPressed: (int index) async {
              ...
              if (t.getIcons1()[index].icon == Icons.format_bold) {
                var proceed = await widget.htmlToolbarOptions.onButtonPressed?.call(ButtonType.bold, _fontSelected[index], updateStatus) ?? true;
                if (proceed) {
              ...
              if (t.getIcons1()[index].icon == Icons.format_italic) {
                var proceed = await widget.htmlToolbarOptions.onButtonPressed?.call(ButtonType.italic, _fontSelected[index], updateStatus) ?? true;
                if (proceed) {
              ...
              if (t.getIcons1()[index].icon == Icons.format_underline) {
                var proceed = await widget.htmlToolbarOptions.onButtonPressed?.call(ButtonType.underline, _fontSelected[index], updateStatus) ?? true;
                if (proceed) {
              ...
              if (t.getIcons1()[index].icon == Icons.format_clear) {
                var proceed = await widget.htmlToolbarOptions.onButtonPressed?.call(ButtonType.clearFormatting, null, null) ?? true;
                if (proceed) {
          ...
          toolbarChildren.add(ToggleButtons(
            ...
            onPressed: (int index) async {
              ...
              if (t.getIcons2()[index].icon == Icons.format_strikethrough) {
                var proceed = await widget.htmlToolbarOptions.onButtonPressed?.call(ButtonType.strikethrough, _miscFontSelected[index], updateStatus) ?? true;
                if (proceed) {
              ...
              if (t.getIcons2()[index].icon == Icons.superscript) {
                var proceed = await widget.htmlToolbarOptions.onButtonPressed?.call(ButtonType.superscript, _miscFontSelected[index], updateStatus) ?? true;
                if (proceed) {
              ...
              if (t.getIcons2()[index].icon == Icons.subscript) {
                var proceed = await widget.htmlToolbarOptions.onButtonPressed?.call(ButtonType.subscript, _miscFontSelected[index], updateStatus) ?? true;
                if (proceed) {
          ...
          onPressed: (int index) async {
            ...
            if (_colorSelected[index]) {
              if (t.getIcons()[index].icon == Icons.format_color_text) {
                var proceed = await widget.htmlToolbarOptions.onButtonPressed?.call(ButtonType.foregroundColor, _colorSelected[index], updateStatus) ?? true;
                if (proceed) {
                  widget.controller.execCommand('foreColor', argument: (Colors.black.value & 0xFFFFFF).toRadixString(16).padLeft(6, '0').toUpperCase());
                  updateStatus(null);
                }
              }
              if (t.getIcons()[index].icon == Icons.format_color_fill) {
                var proceed = await widget.htmlToolbarOptions.onButtonPressed?.call(ButtonType.highlightColor, _colorSelected[index], updateStatus) ?? true;
                if (proceed) {
                  widget.controller.execCommand('hiliteColor', argument: (Colors.yellow.value & 0xFFFFFF).toRadixString(16).padLeft(6, '0').toUpperCase());
                  updateStatus(null);
                }
              }
            } else {
              var proceed = true;
              if (t.getIcons()[index].icon == Icons.format_color_text) {
                proceed = await widget.htmlToolbarOptions.onButtonPressed?.call(ButtonType.foregroundColor, _colorSelected[index], updateStatus) ?? true;
              } else if (t.getIcons()[index].icon == Icons.format_color_fill) {
                proceed = await widget.htmlToolbarOptions.onButtonPressed?.call(ButtonType.highlightColor, _colorSelected[index], updateStatus) ?? true;
              }
              if (proceed) {
                late Color newColor;
                if (t.getIcons()[index].icon == Icons.format_color_text) {
                      ...
                      return PointerInterceptor(
                        child: AlertDialog(
                          ...
                          content: ColorPicker(
                            ...
                            title: Text('Choose a Color', style: Theme.of(context).textTheme.headlineSmall),
                            width: 40,
                            height: 40,
                            spacing: 0,
                            runSpacing: 0,
                          ...
                          actions: <Widget>[
                            ...
                            TextButton(
                              onPressed: () {
                                if (t.getIcons()[index].icon == Icons.format_color_text) {
                                  widget.controller.execCommand('foreColor', argument: (newColor.value & 0xFFFFFF).toRadixString(16).padLeft(6, '0').toUpperCase());
                                  setState(mounted, this.setState, () {
                                    _foreColorSelected = newColor;
                                  });
                                }
                                if (t.getIcons()[index].icon == Icons.format_color_fill) {
                                  widget.controller.execCommand('hiliteColor', argument: (newColor.value & 0xFFFFFF).toRadixString(16).padLeft(6, '0').toUpperCase());
                                  setState(mounted, this.setState, () {
          ...
          toolbarChildren.add(ToggleButtons(
            ...
            onPressed: (int index) async {
              ...
              if (t.getIcons()[index].icon == Icons.format_list_bulleted) {
                var proceed = await widget.htmlToolbarOptions.onButtonPressed?.call(ButtonType.ul, _listSelected[index], updateStatus) ?? true;
                if (proceed) {
              ...
              if (t.getIcons()[index].icon == Icons.format_list_numbered) {
                var proceed = await widget.htmlToolbarOptions.onButtonPressed?.call(ButtonType.ol, _listSelected[index], updateStatus) ?? true;
                if (proceed) {
            ...
            child: CustomDropdownButtonHideUnderline(
              child: CustomDropdownButton<String>(
                ...
                onChanged: (String? changed) async {
                  ...
                  if (changed != null) {
                    var proceed = await widget.htmlToolbarOptions.onDropdownChanged?.call(DropdownType.listStyles, changed, updateSelectedItem) ?? true;
                    if (proceed) {
                      if (kIsWeb) {
          ...
          toolbarChildren.add(ToggleButtons(
            ...
            onPressed: (int index) async {
              ...
              if (t.getIcons1()[index].icon == Icons.format_align_left) {
                var proceed = await widget.htmlToolbarOptions.onButtonPressed?.call(ButtonType.alignLeft, _alignSelected[index], updateStatus) ?? true;
                if (proceed) {
              ...
              if (t.getIcons1()[index].icon == Icons.format_align_center) {
                var proceed = await widget.htmlToolbarOptions.onButtonPressed?.call(ButtonType.alignCenter, _alignSelected[index], updateStatus) ?? true;
                if (proceed) {
              ...
              if (t.getIcons1()[index].icon == Icons.format_align_right) {
                var proceed = await widget.htmlToolbarOptions.onButtonPressed?.call(ButtonType.alignRight, _alignSelected[index], updateStatus) ?? true;
                if (proceed) {
              ...
              if (t.getIcons1()[index].icon == Icons.format_align_justify) {
                var proceed = await widget.htmlToolbarOptions.onButtonPressed?.call(ButtonType.alignJustify, _alignSelected[index], updateStatus) ?? true;
                if (proceed) {
          ...
          toolbarChildren.add(ToggleButtons(
            ...
            onPressed: (int index) async {
              if (t.getIcons2()[index].icon == Icons.format_indent_increase) {
                var proceed = await widget.htmlToolbarOptions.onButtonPressed?.call(ButtonType.increaseIndent, null, null) ?? true;
                if (proceed) {
                  widget.controller.execCommand('indent');
                }
              }
              if (t.getIcons2()[index].icon == Icons.format_indent_decrease) {
                var proceed = await widget.htmlToolbarOptions.onButtonPressed?.call(ButtonType.decreaseIndent, null, null) ?? true;
                if (proceed) {
          ...
          toolbarChildren.add(Container(
            ...
            child: CustomDropdownButtonHideUnderline(
              child: CustomDropdownButton<double>(
                ...
                style: widget.htmlToolbarOptions.textStyle,
                items: [
                  CustomDropdownMenuItem(value: 1, child: PointerInterceptor(child: Text('1.0'))),
                  CustomDropdownMenuItem(
                    value: 1.2,
                  ...
                  CustomDropdownMenuItem(value: 3, child: PointerInterceptor(child: Text('3.0'))),
                ],
                ...
                onChanged: (double? changed) async {
                  ...
                  if (changed != null) {
                    var proceed = await widget.htmlToolbarOptions.onDropdownChanged?.call(DropdownType.lineHeight, changed, updateSelectedItem) ?? true;
                    if (proceed) {
                      if (kIsWeb) {
                        widget.controller.changeLineHeight(changed.toString());
                      } else {
                        await widget.controller.editorController!.evaluateJavascript(source: "\$('#summernote-2').summernote('lineHeight', '$changed');");
                      }
                      updateSelectedItem(changed);
                    }
                  }
        ...
        if (t.textDirection) {
          toolbarChildren.add(ToggleButtons(
            ...
            onPressed: (int index) async {
              ...
              var proceed = await widget.htmlToolbarOptions.onButtonPressed?.call(index == 0 ? ButtonType.ltr : ButtonType.rtl, _alignSelected[index], updateStatus) ?? true;
              if (proceed) {
                if (kIsWeb) {
          ...
          toolbarChildren.add(Container(
            ...
            child: CustomDropdownButtonHideUnderline(
              child: CustomDropdownButton<String>(
                ...
                onChanged: (String? changed) async {
                  if (changed != null) {
                    var proceed = await widget.htmlToolbarOptions.onDropdownChanged?.call(DropdownType.caseConverter, changed, null) ?? true;
                    if (proceed) {
                      if (kIsWeb) {
      ...
      if (t is InsertButtons && (t.audio || t.video || t.otherFile || t.picture || t.link || t.hr || t.table)) {
        toolbarChildren.add(ToggleButtons(
          constraints: BoxConstraints.tightFor(
            width: widget.htmlToolbarOptions.toolbarItemHeight - 2,
            height: widget.htmlToolbarOptions.toolbarItemHeight - 2,
          ...
          onPressed: (int index) async {
            if (t.getIcons()[index].icon == Icons.link) {
              var proceed = await widget.htmlToolbarOptions.onButtonPressed?.call(ButtonType.link, null, null) ?? true;
              if (proceed) {
                                ...
                                Row(
                                  children: <Widget>[
                                    ...
                                    ElevatedButton(
                                      ...
                                      child: Text('Open in new window', style: TextStyle(color: Theme.of(context).textTheme.bodySmall?.color)),
                                    ),
                                  ],
                                ),
                              ]),
                              ...
                              TextButton(
                                onPressed: () async {
                                  if (formKey.currentState!.validate()) {
                                    var proceed =
                                        await widget.htmlToolbarOptions.linkInsertInterceptor?.call(text.text.isEmpty ? url.text : text.text, url.text, openNewTab) ?? true;
                                    if (proceed) {
                        ...
                        child: StatefulBuilder(builder: (BuildContext context, StateSetter setState) {
                          return AlertDialog(
                            ...
                            content: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [
                              if (widget.htmlToolbarOptions.allowImagePicking) Text('Select from files', style: TextStyle(fontWeight: FontWeight.bold)),
                              if (widget.htmlToolbarOptions.allowImagePicking) SizedBox(height: 10),
                              if (widget.htmlToolbarOptions.allowImagePicking && filename.text.isEmpty)
                                ElevatedButton(
                                  // style: ElevatedButton.styleFrom(
                                  //     backgroundColor: Theme.of(context).dialogBackgroundColor, padding: EdgeInsets.only(left: 5, right: 5), elevation: 0.0),
                                  onPressed: () async {
                                  ...
                                  child: Text('Choose image', style: TextStyle(color: Theme.of(context).textTheme.bodySmall?.color)),
                                ),
                              if (widget.htmlToolbarOptions.allowImagePicking && filename.text.isNotEmpty)
                                TextFormField(
                                    controller: filename,
                                    readOnly: true,
                                    decoration: InputDecoration(
                              ...
                              if (widget.htmlToolbarOptions.allowImagePicking) Text('URL', style: TextStyle(fontWeight: FontWeight.bold)),
                              if (widget.htmlToolbarOptions.allowImagePicking) SizedBox(height: 10),
                              TextField(
                                controller: url,
                                focusNode: urlFocus,
                              ...
                              TextButton(
                                onPressed: () async {
                                  if (filename.text.isEmpty && url.text.isEmpty) {
                                    setState(() {
                                      validateFailed =
                                          widget.htmlToolbarOptions.allowImagePicking ? 'Please either choose an image or enter an image URL!' : 'Please enter an image URL!';
                                    });
                                    ...
                                    if (proceed) {
                                      widget.controller
                                          .insertHtml("<img src='data:image/${result!.files.single.extension};base64,$base64Data' data-filename='${result!.files.single.name}'/>");
                                    }
                                    Navigator.of(context).pop();
                                  } else {
            ...
            if (t.getIcons()[index].icon == Icons.audiotrack_outlined) {
              var proceed = await widget.htmlToolbarOptions.onButtonPressed?.call(ButtonType.audio, null, null) ?? true;
              if (proceed) {
                final filename = TextEditingController();
                final url = TextEditingController();
                final urlFocus = FocusNode();
                              ...
                              TextFormField(
                                  ...
                                  decoration: InputDecoration(
                                    prefixIcon: ElevatedButton(
                                      ...
                                      child: Text('Choose audio', style: TextStyle(color: Theme.of(context).textTheme.bodySmall?.color)),
                                    ),
                                    suffixIcon: result != null
                                        ? IconButton(
                                            icon: Icon(Icons.close),
                              ...
                              TextButton(
                                onPressed: () async {
                                  if (filename.text.isEmpty && url.text.isEmpty) {
                                    ...
                                    var base64Data = base64.encode(result!.files.single.bytes!);
                                    var proceed = await widget.htmlToolbarOptions.mediaUploadInterceptor?.call(result!.files.single, InsertFileType.audio) ?? true;
                                    if (proceed) {
                                    ...
                                    var proceed = await widget.htmlToolbarOptions.mediaLinkInsertInterceptor?.call(url.text, InsertFileType.audio) ?? true;
                                    if (proceed) {
            ...
            if (t.getIcons()[index].icon == Icons.videocam_outlined) {
              var proceed = await widget.htmlToolbarOptions.onButtonPressed?.call(ButtonType.video, null, null) ?? true;
              if (proceed) {
                final filename = TextEditingController();
                final url = TextEditingController();
                final urlFocus = FocusNode();
                              ...
                              TextFormField(
                                  ...
                                  decoration: InputDecoration(
                                    prefixIcon: ElevatedButton(
                                      ...
                                      child: Text('Choose video', style: TextStyle(color: Theme.of(context).textTheme.bodySmall?.color)),
                                    ),
                                    suffixIcon: result != null
                                        ? IconButton(
                                            icon: Icon(Icons.close),
                              ...
                              TextButton(
                                onPressed: () async {
                                  if (filename.text.isEmpty && url.text.isEmpty) {
                                    ...
                                    var base64Data = base64.encode(result!.files.single.bytes!);
                                    var proceed = await widget.htmlToolbarOptions.mediaUploadInterceptor?.call(result!.files.single, InsertFileType.video) ?? true;
                                    if (proceed) {
                                      widget.controller.insertHtml(
                                    ...
                                    var proceed = await widget.htmlToolbarOptions.mediaLinkInsertInterceptor?.call(url.text, InsertFileType.video) ?? true;
                                    if (proceed) {
            ...
            if (t.getIcons()[index].icon == Icons.attach_file) {
              var proceed = await widget.htmlToolbarOptions.onButtonPressed?.call(ButtonType.otherFile, null, null) ?? true;
              if (proceed) {
                final filename = TextEditingController();
                final url = TextEditingController();
                final urlFocus = FocusNode();
                              ...
                              TextFormField(
                                  ...
                                  decoration: InputDecoration(
                                    prefixIcon: ElevatedButton(
                                      ...
                                      child: Text('Choose file', style: TextStyle(color: Theme.of(context).textTheme.bodySmall?.color)),
                                    ),
                                    suffixIcon: result != null
                                        ? IconButton(
                                            icon: Icon(Icons.close),
                              ...
                              TextButton(
                                onPressed: () {
                                  if (filename.text.isEmpty && url.text.isEmpty) {
                                    ...
                                    widget.htmlToolbarOptions.onOtherFileUpload?.call(result!.files.single);
                                    Navigator.of(context).pop();
                                  } else {
            ...
            if (t.getIcons()[index].icon == Icons.table_chart_outlined) {
              var proceed = await widget.htmlToolbarOptions.onButtonPressed?.call(ButtonType.table, null, null) ?? true;
              if (proceed) {
                var currentRows = 1;
                var currentCols = 1;
                await showDialog(
                      ...
                      return PointerInterceptor(
                        child: StatefulBuilder(builder: (BuildContext context, StateSetter setState) {
                          return AlertDialog(
                            ...
                            scrollable: true,
                            content: Row(mainAxisSize: MainAxisSize.min, mainAxisAlignment: MainAxisAlignment.spaceAround, children: [
                              NumberPicker(
                                value: currentRows,
                                minValue: 1,
                                maxValue: 10,
                                ...
                                onPressed: () async {
                                  if (kIsWeb) {
                                    ...
                                    await widget.controller.editorController!
                                        .evaluateJavascript(source: "\$('#summernote-2').summernote('insertTable', '${currentRows}x$currentCols');");
                                  }
                                  Navigator.of(context).pop();
                                },
                                child: Text('OK'),
            ...
            if (t.getIcons()[index].icon == Icons.horizontal_rule) {
              var proceed = await widget.htmlToolbarOptions.onButtonPressed?.call(ButtonType.hr, null, null) ?? true;
              if (proceed) {
          ...
          toolbarChildren.add(ToggleButtons(
            ...
            onPressed: (int index) async {
              ...
              if (t.getIcons1()[index].icon == Icons.fullscreen) {
                var proceed = await widget.htmlToolbarOptions.onButtonPressed?.call(ButtonType.fullscreen, _miscSelected[index], updateStatus) ?? true;
                if (proceed) {
              ...
              if (t.getIcons1()[index].icon == Icons.code) {
                var proceed = await widget.htmlToolbarOptions.onButtonPressed?.call(ButtonType.codeview, _miscSelected[index], updateStatus) ?? true;
                if (proceed) {
              ...
              if (t.getIcons1()[index].icon == Icons.help_outline) {
                var proceed = await widget.htmlToolbarOptions.onButtonPressed?.call(ButtonType.help, null, null) ?? true;
                if (proceed) {
                  await showDialog(
                      context: context,
                      builder: (BuildContext context) {
          ...
          toolbarChildren.add(ToggleButtons(
            ...
            onPressed: (int index) async {
              if (t.getIcons2()[index].icon == Icons.copy) {
                var proceed = await widget.htmlToolbarOptions.onButtonPressed?.call(ButtonType.copy, null, null) ?? true;
                if (proceed) {
    ...
    if (widget.htmlToolbarOptions.customToolbarInsertionIndices.isNotEmpty &&
        widget.htmlToolbarOptions.customToolbarInsertionIndices.length == widget.htmlToolbarOptions.customToolbarButtons.length) {
      for (var i = 0; i < widget.htmlToolbarOptions.customToolbarInsertionIndices.length; i++) {
        if (widget.htmlToolbarOptions.customToolbarInsertionIndices[i] > toolbarChildren.length) {
          ...
          toolbarChildren.insert(widget.htmlToolbarOptions.customToolbarInsertionIndices[i], widget.htmlToolbarOptions.customToolbarButtons[i]);
        }
      }
    } else {
